 ...
 const trendingTopics = [
   {
     ...
     category: "Legal",
     responses: 156,
     url: "https://www.startupindia.gov.in/content/sih/en/bloglist/blogs/how-to-use-the-startup-india-portal-from-registration-to-growth.html"
   },
   {
     title: "Setting up ESOP for employees",
     category: "HR",
     responses: 89,
     url: "https://www.mysa.io/blogs/how-to-issue-esop"
   },
   {
     title: "Understanding GST for startups",
     category: "Finance",
     responses: 203,
     url: "https://gstman.com/gst-compliance-for-startups-a-step-by-step-guide/"
   },
   {
 ...
 const recentAnswers = [
   {
     ...
     downloads: [
       {
         name: "Company Registration Checklist",
         url: "https://drive.google.com/file/d/1ERshsYH9h5lRvhDiZJsTrQREyzpuuG2z/view?usp=sharing"
       },
       {
         name: "MoA Template",
         url: "https://docs.google.com/document/d/1dJPtJmoII3ZaYmTeSztLN3GtYEJ4ha7vmLdJLg9hQ1c/edit?usp=sharing"
       }
     ]
   },
   {
     ...
     downloads: [
       {
         ...
         url: "https://drive.google.com/file/d/1Bpns-rU8MktR6gYTnC8dfdWMVLuBakyR/view"
       },
       {
         name: "Founder Agreement Template",
         url: "https://drive.google.com/file/d/1DGhoVqOIBlJduhIU4GguFzjvXBpG-K_M/view?usp=drive_link"
       }
     ]
   },
 ];
               ...
               <CardContent>
                 ...
                 <div className="space-y-2">
                   ...
                   <div className="flex flex-wrap gap-2">
                     {answer.downloads.map((file, idx) => (
                       <a
                         key={idx}
                         href={file.url}
                         target="_blank"
                         rel="noopener noreferrer"
                         className="inline-flex items-center px-3 py-1.5 text-xs font-medium rounded-md border border-input bg-background shadow-sm hover:bg-accent hover:text-accent-foreground transition-colors"
                       >
